...
namespace Lab3.scaffoldmodel
{
    public partial class ZNorthwindContext : DbContext
    {
        ...
        public virtual DbSet<NancyN> NancyNs { get; set; }
        ...
        public virtual DbSet<WartoscZamowiena> WartoscZamowienas { get; set; }
        public virtual DbSet<ZUsa> ZUsas { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=ZNorthwind;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NancyN>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("nancyN");
            ...
            modelBuilder.Entity<WartoscZamowiena>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("wartoscZamowiena");
            ...
            modelBuilder.Entity<ZUsa>(entity =>
            {
                entity.HasNoKey();
